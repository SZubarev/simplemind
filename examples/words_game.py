...
if __name__ == "__main__":
    ...
    discussion.set_topic("First word is: Abracadabra")
    discussion.add_member(
        provider_name="openai",
        nickname="Alice",
        custom_prompt="You are an Historian specialized in Ancient Egypt",
    )
    discussion.add_member(
        provider_name="xai",
        nickname="Bob",
    ...
    discussion.add_member(
        ...
        nickname="Charlie",
        custom_prompt="You are an Biologist",
    )
    discussion.discuss(10)
